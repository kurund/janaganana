...
ALTER TABLE ONLY public.schools_type DROP CONSTRAINT pk_schools_type;
DROP TABLE public.schools_type;
...
COPY public.schools_type (geo_level, geo_code, geo_version, schools, type, total) FROM stdin;
