...
-- Started on 2018-07-19 18:49:13 IST
...
ALTER TABLE IF EXISTS ONLY public.area_sex_maritalstatus_2011 DROP CONSTRAINT IF EXISTS pk_area_sex_maritalstatus_2011;
DROP TABLE IF EXISTS public.area_sex_maritalstatus_2011;
SET default_tablespace = '';

SET default_with_oids = false;

--
-- TOC entry 264 (class 1259 OID 28383)
-- Name: area_sex_maritalstatus_2011; Type: TABLE; Schema: public; Owner: wazimap
--

CREATE TABLE public.area_sex_maritalstatus_2011 (
...
ALTER TABLE public.area_sex_maritalstatus_2011 OWNER TO wazimap;

--
-- TOC entry 2381 (class 0 OID 28383)
-- Dependencies: 264
-- Data for Name: area_sex_maritalstatus_2011; Type: TABLE DATA; Schema: public; Owner: wazimap
--

COPY public.area_sex_maritalstatus_2011 (geo_level, geo_code, geo_version, area, sex, maritalstatus, year, total) FROM stdin WITH DELIMITER ',';
...
state,28,2011,Rural,Female,never married,2011,6024455
state,28,2011,Rural,Female,widowed,2011,1951286
state,28,2011,Urban,Female,unspecified,2011,0
state,28,2011,Urban,Male,divorced,2011,3038
state,28,2011,Rural,Male,never married,2011,8038712
state,28,2011,Urban,Female,divorced,2011,8793
state,28,2011,Rural,Male,widowed,2011,374659
state,28,2011,Urban,Male,unspecified,2011,0
state,28,2011,Urban,Male,currently married,2011,3699757
state,28,2011,Urban,Male,separated,2011,16152
state,28,2011,Rural,Male,divorced,2011,6610
state,28,2011,Urban,Female,never married,2011,2724045
state,28,2011,Urban,Female,separated,2011,47678
state,28,2011,Rural,Female,divorced,2011,23368
state,28,2011,Urban,Male,widowed,2011,114882
state,28,2011,Rural,Male,unspecified,2011,0
state,28,2011,Urban,Female,currently married,2011,3805564
state,28,2011,Urban,Male,never married,2011,3458436
state,28,2011,Rural,Male,currently married,2011,8973866
state,28,2011,Rural,Male,separated,2011,51956
state,28,2011,Rural,Female,separated,2011,149183
state,28,2011,Rural,Female,currently married,2011,9182294
state,28,2011,Urban,Female,widowed,2011,732065
state,28,2011,Rural,Female,unspecified,2011,0
state,36,2011,Rural,Female,never married,2011,3967600
state,36,2011,Rural,Female,widowed,2011,1129620
state,36,2011,Urban,Female,unspecified,2011,0
state,36,2011,Urban,Male,divorced,2011,3021
state,36,2011,Rural,Male,never married,2011,5188680
state,36,2011,Urban,Female,divorced,2011,8631
state,36,2011,Rural,Male,widowed,2011,200904
state,36,2011,Urban,Male,unspecified,2011,0
state,36,2011,Urban,Male,currently married,2011,3349754
state,36,2011,Urban,Male,separated,2011,9092
state,36,2011,Rural,Male,divorced,2011,6920
state,36,2011,Urban,Female,never married,2011,2701294
state,36,2011,Urban,Female,separated,2011,24858
state,36,2011,Rural,Female,divorced,2011,25899
state,36,2011,Urban,Male,widowed,2011,78389
state,36,2011,Rural,Male,unspecified,2011,0
state,36,2011,Urban,Female,currently married,2011,3482732
state,36,2011,Urban,Male,never married,2011,3466384
state,36,2011,Rural,Male,currently married,2011,5375904
state,36,2011,Rural,Male,separated,2011,25030
state,36,2011,Rural,Female,separated,2011,83327
state,36,2011,Rural,Female,currently married,2011,5581429
state,36,2011,Urban,Female,widowed,2011,484510
state,36,2011,Rural,Female,unspecified,2011,0
\.


--
-- TOC entry 2266 (class 2606 OID 28391)
-- Name: pk_area_sex_maritalstatus_2011; Type: CONSTRAINT; Schema: public; Owner: wazimap
--

ALTER TABLE ONLY public.area_sex_maritalstatus_2011
    ADD CONSTRAINT pk_area_sex_maritalstatus_2011 PRIMARY KEY (geo_level, geo_code, geo_version, area, sex, maritalstatus, year);


-- Completed on 2018-07-19 18:49:13 IST
