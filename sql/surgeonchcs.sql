...
-- Started on 2018-07-05 15:55:47 IST
...
ALTER TABLE IF EXISTS ONLY public.surgeonchcs DROP CONSTRAINT IF EXISTS pk_surgeonchcs;
DROP TABLE IF EXISTS public.surgeonchcs;
SET default_tablespace = '';

SET default_with_oids = false;

--
-- TOC entry 247 (class 1259 OID 21873)
-- Name: surgeonchcs; Type: TABLE; Schema: public; Owner: wazimap
--

CREATE TABLE public.surgeonchcs (
...
ALTER TABLE public.surgeonchcs OWNER TO wazimap;

--
-- TOC entry 2322 (class 0 OID 21873)
-- Dependencies: 247
-- Data for Name: surgeonchcs; Type: TABLE DATA; Schema: public; Owner: wazimap
--

COPY public.surgeonchcs (geo_level, geo_code, surgeonchcs, total) FROM stdin WITH DELIMITER ',';
country,IN,Required,5624
country,IN,Available,758
...
state,28,Available,38
state,12,Required,63
state,12,Available,0
state,18,Required,158
state,18,Available,12
state,10,Required,150
state,10,Available,13
state,4,Required,2
state,4,Available,0
state,22,Required,169
state,22,Available,15
state,26,Required,2
...
state,24,Available,27
state,6,Required,112
state,6,Available,2
state,2,Required,89
state,2,Available,4
state,1,Required,84
state,1,Available,43
state,20,Required,188
state,20,Available,25
state,29,Required,206
state,29,Available,128
state,32,Required,232
state,32,Available,1
state,31,Required,3
state,31,Available,0
state,23,Required,309
state,23,Available,42
state,27,Required,360
state,27,Available,26
state,14,Required,17
state,14,Available,0
state,17,Required,27
state,17,Available,0
state,15,Required,9
state,15,Available,0
state,13,Required,21
state,13,Available,2
state,7,Required,0
state,7,Available,0
state,21,Required,370
state,21,Available,68
state,34,Required,4
state,34,Available,0
state,3,Required,151
state,3,Available,50
state,8,Required,579
state,8,Available,127
state,11,Required,2
state,11,Available,0
state,33,Required,385
state,33,Available,2
state,36,Required,114
state,36,Available,14
state,16,Required,21
state,16,Available,0
state,9,Required,822
state,9,Available,112
state,5,Required,60
state,5,Available,6
state,19,Required,349
state,19,Available,0
\.


--
-- TOC entry 2207 (class 2606 OID 21878)
-- Name: pk_surgeonchcs; Type: CONSTRAINT; Schema: public; Owner: wazimap
--

ALTER TABLE ONLY public.surgeonchcs
    ADD CONSTRAINT pk_surgeonchcs PRIMARY KEY (geo_level, geo_code, geo_version, surgeonchcs);


-- Completed on 2018-07-05 15:55:47 IST
