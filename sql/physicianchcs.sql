...
-- Started on 2018-07-04 17:58:25 IST
...
ALTER TABLE IF EXISTS ONLY public.physicianchcs DROP CONSTRAINT IF EXISTS pk_physicianchcs;
DROP TABLE IF EXISTS public.physicianchcs;
SET default_tablespace = '';

SET default_with_oids = false;

--
-- TOC entry 246 (class 1259 OID 21867)
-- Name: physicianchcs; Type: TABLE; Schema: public; Owner: wazimap
--

CREATE TABLE public.physicianchcs (
...
ALTER TABLE public.physicianchcs OWNER TO wazimap;

--
-- TOC entry 2319 (class 0 OID 21867)
-- Dependencies: 246
-- Data for Name: physicianchcs; Type: TABLE DATA; Schema: public; Owner: wazimap
--

COPY public.physicianchcs (geo_level, geo_code, physicianchcs, total) FROM stdin WITH DELIMITER ',';
country,IN,Required,5624
country,IN,Available,864
...
state,28,Available,56
state,12,Required,63
state,12,Available,1
state,18,Required,158
state,18,Available,31
state,10,Required,150
state,10,Available,8
state,4,Required,2
state,4,Available,1
state,22,Required,169
state,22,Available,9
state,26,Required,2
state,26,Available,0
state,25,Required,2
state,25,Available,0
state,30,Required,4
state,30,Available,1
state,24,Required,363
state,24,Available,9
state,6,Required,112
state,6,Available,4
state,2,Required,89
state,2,Available,5
state,1,Required,84
state,1,Available,45
state,20,Required,188
state,20,Available,8
state,29,Required,206
state,29,Available,106
state,32,Required,232
state,32,Available,2
state,31,Required,3
state,31,Available,0
state,23,Required,309
state,23,Available,41
state,27,Required,360
state,27,Available,45
state,14,Required,17
state,14,Available,1
state,17,Required,27
state,17,Available,12
state,15,Required,9
state,15,Available,0
state,13,Required,21
state,13,Available,0
state,7,Required,0
state,7,Available,0
state,21,Required,370
state,21,Available,58
state,34,Required,4
state,34,Available,1
state,3,Required,151
state,3,Available,48
state,8,Required,579
state,8,Available,189
state,11,Required,2
state,11,Available,1
state,33,Required,385
state,33,Available,11
state,36,Required,114
state,36,Available,21
state,16,Required,21
state,16,Available,0
state,9,Required,822
state,9,Available,103
state,5,Required,60
state,5,Available,11
state,19,Required,349
state,19,Available,36
\.


--
-- TOC entry 2204 (class 2606 OID 21872)
-- Name: pk_physicianchcs; Type: CONSTRAINT; Schema: public; Owner: wazimap
--

ALTER TABLE ONLY public.physicianchcs
    ADD CONSTRAINT pk_physicianchcs PRIMARY KEY (geo_level, geo_code, geo_version, physicianchcs);


-- Completed on 2018-07-04 17:58:25 IST
