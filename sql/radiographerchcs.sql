...
-- Started on 2018-07-05 16:38:21 IST
...
ALTER TABLE IF EXISTS ONLY public.radiographerchcs DROP CONSTRAINT IF EXISTS pk_radiographerchcs;
DROP TABLE IF EXISTS public.radiographerchcs;
SET default_tablespace = '';

SET default_with_oids = false;

--
-- TOC entry 248 (class 1259 OID 21880)
-- Name: radiographerchcs; Type: TABLE; Schema: public; Owner: wazimap
--

CREATE TABLE public.radiographerchcs (
...
ALTER TABLE public.radiographerchcs OWNER TO wazimap;

--
-- TOC entry 2325 (class 0 OID 21880)
-- Dependencies: 248
-- Data for Name: radiographerchcs; Type: TABLE DATA; Schema: public; Owner: wazimap
--

COPY public.radiographerchcs (geo_level, geo_code, radiographerchcs, total) FROM stdin DELIMITER ',';
country,IN,Required,5624
country,IN,Available,2129
...
state,35,Required,4
state,35,Available,0
state,28,Required,193
state,28,Available,75
state,12,Required,63
state,12,Available,7
state,18,Required,158
state,18,Available,60
state,10,Required,150
state,10,Available,1
state,4,Required,2
state,4,Available,5
state,22,Required,169
state,22,Available,130
state,26,Required,2
state,26,Available,0
state,25,Required,2
state,25,Available,3
state,30,Required,4
state,30,Available,6
state,24,Required,363
state,24,Available,162
state,6,Required,112
state,6,Available,40
state,2,Required,89
state,2,Available,33
state,1,Required,84
state,1,Available,210
state,20,Required,188
state,20,Available,57
state,29,Required,206
state,29,Available,167
state,32,Required,232
state,32,Available,18
state,31,Required,3
state,31,Available,5
state,23,Required,309
state,23,Available,176
state,27,Required,360
state,27,Available,107
state,14,Required,17
state,14,Available,13
state,17,Required,27
state,17,Available,21
state,15,Required,9
state,15,Available,6
state,13,Required,21
state,13,Available,1
state,7,Required,0
state,7,Available,0
state,21,Required,370
state,21,Available,68
state,34,Required,4
state,34,Available,3
state,3,Required,151
state,3,Available,129
state,8,Required,579
state,8,Available,205
state,11,Required,2
state,11,Available,1
state,33,Required,385
state,33,Available,119
state,36,Required,114
state,36,Available,58
state,16,Required,21
state,16,Available,11
state,9,Required,822
state,9,Available,82
state,5,Required,60
state,5,Available,15
state,19,Required,349
state,19,Available,135
\.


--
-- TOC entry 2210 (class 2606 OID 21885)
-- Name: pk_radiographerchcs; Type: CONSTRAINT; Schema: public; Owner: wazimap
--

ALTER TABLE ONLY public.radiographerchcs
    ADD CONSTRAINT pk_radiographerchcs PRIMARY KEY (geo_level, geo_code, geo_version, radiographerchcs);


-- Completed on 2018-07-05 16:38:21 IST
