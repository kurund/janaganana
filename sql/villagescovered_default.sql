...
-- Started on 2018-09-06 16:01:49 IST
...
ALTER TABLE IF EXISTS ONLY public.villagescovered_default DROP CONSTRAINT IF EXISTS pk_villagescovered_default;
DROP TABLE IF EXISTS public.villagescovered_default;
SET default_tablespace = '';

SET default_with_oids = false;

--
-- TOC entry 276 (class 1259 OID 18379)
-- Name: villagescovered_default; Type: TABLE; Schema: public; Owner: wazimap
--

CREATE TABLE public.villagescovered_default (
...
ALTER TABLE public.villagescovered_default OWNER TO wazimap;

--
-- TOC entry 2515 (class 0 OID 18379)
-- Dependencies: 276
-- Data for Name: villagescovered_default; Type: TABLE DATA; Schema: public; Owner: wazimap
--

COPY public.villagescovered_default (geo_level, geo_code, geo_version, villagescovered, year, total) FROM stdin WITH DELIMITER ',';
...
--
-- TOC entry 2400 (class 2606 OID 18384)
-- Name: pk_villagescovered_default; Type: CONSTRAINT; Schema: public; Owner: wazimap
--

ALTER TABLE ONLY public.villagescovered_default
    ADD CONSTRAINT pk_villagescovered_default PRIMARY KEY (geo_level, geo_code, geo_version, villagescovered, year);


-- Completed on 2018-09-06 16:01:49 IST
