...
-- Started on 2018-07-06 12:29:08 IST
...
ALTER TABLE IF EXISTS ONLY public.nursestaffphcschcs DROP CONSTRAINT IF EXISTS pk_nursestaffphcschcs;
DROP TABLE IF EXISTS public.nursestaffphcschcs;
SET default_tablespace = '';

SET default_with_oids = false;

--
-- TOC entry 251 (class 1259 OID 21898)
-- Name: nursestaffphcschcs; Type: TABLE; Schema: public; Owner: wazimap
--

CREATE TABLE public.nursestaffphcschcs (
...
ALTER TABLE public.nursestaffphcschcs OWNER TO wazimap;

--
-- TOC entry 2334 (class 0 OID 21898)
-- Dependencies: 251
-- Data for Name: nursestaffphcschcs; Type: TABLE DATA; Schema: public; Owner: wazimap
--

COPY public.nursestaffphcschcs (geo_level, geo_code, nursestaffphcschcs, total) FROM stdin WITH DELIMITER ',';
country,IN,Required,65018
country,IN,Available,70738
...
state,35,Required,50
state,35,Available,193
state,28,Required,2498
state,28,Available,3541
state,12,Required,584
state,12,Available,498
state,18,Required,2120
state,18,Available,2793
state,10,Required,2949
state,10,Available,1142
state,4,Required,17
state,4,Available,80
state,22,Required,1968
state,22,Available,1918
state,26,Required,23
state,26,Available,45
state,25,Required,18
state,25,Available,16
state,30,Required,52
state,30,Available,129
state,24,Required,3933
state,24,Available,3529
state,6,Required,1150
state,6,Available,1675
state,2,Required,1161
state,2,Available,542
state,1,Required,1225
state,1,Available,1480
state,20,Required,1613
state,20,Available,1136
state,29,Required,3801
state,29,Available,3339
state,32,Required,2473
state,32,Available,3969
state,31,Required,25
state,31,Available,54
state,23,Required,3334
state,23,Available,3211
state,27,Required,4334
state,27,Available,2519
state,14,Required,204
state,14,Available,397
state,17,Required,298
state,17,Available,610
state,15,Required,120
state,15,Available,212
state,13,Required,273
state,13,Available,387
state,7,Required,5
state,7,Available,7
state,21,Required,3870
state,21,Available,1817
state,34,Required,68
state,34,Available,139
state,3,Required,1489
state,3,Available,2019
state,8,Required,6132
state,8,Available,9311
state,11,Required,38
state,11,Available,33
state,33,Required,4057
state,33,Available,7487
state,36,Required,1487
state,36,Available,1904
state,16,Required,240
state,16,Available,597
state,9,Required,9375
state,9,Available,4412
state,5,Required,677
state,5,Available,349
state,19,Required,3357
state,19,Available,9248
\.


--
-- TOC entry 2219 (class 2606 OID 21903)
-- Name: pk_nursestaffphcschcs; Type: CONSTRAINT; Schema: public; Owner: wazimap
--

ALTER TABLE ONLY public.nursestaffphcschcs
    ADD CONSTRAINT pk_nursestaffphcschcs PRIMARY KEY (geo_level, geo_code, geo_version, nursestaffphcschcs);


-- Completed on 2018-07-06 12:29:08 IST
