...
-- Started on 2018-07-04 16:33:05 IST
...
ALTER TABLE IF EXISTS ONLY public.allopathicdocphcs DROP CONSTRAINT IF EXISTS pk_allopathicdocphcs;
DROP TABLE IF EXISTS public.allopathicdocphcs;
SET default_tablespace = '';

SET default_with_oids = false;

--
-- TOC entry 244 (class 1259 OID 21855)
-- Name: allopathicdocphcs; Type: TABLE; Schema: public; Owner: wazimap
--

CREATE TABLE public.allopathicdocphcs (
...
ALTER TABLE public.allopathicdocphcs OWNER TO wazimap;

--
-- TOC entry 2313 (class 0 OID 21855)
-- Dependencies: 244
-- Data for Name: allopathicdocphcs; Type: TABLE DATA; Schema: public; Owner: wazimap
--

COPY public.allopathicdocphcs (geo_level, geo_code, allopathicdocphcs, total) FROM stdin WITH DELIMITER ',';
country,IN,Required,25650
country,IN,Available,27124
...
state,35,Required,22
state,35,Available,34
state,28,Required,1147
state,28,Available,1644
state,12,Required,143
state,12,Available,122
state,18,Required,1014
state,18,Available,1048
state,10,Required,1899
state,10,Available,1786
state,4,Required,3
state,4,Available,3
state,22,Required,785
state,22,Available,341
state,26,Required,9
state,26,Available,8
state,25,Required,4
state,25,Available,7
state,30,Required,24
state,30,Available,56
state,24,Required,1392
state,24,Available,1229
state,6,Required,366
state,6,Available,429
state,2,Required,538
state,2,Available,492
state,1,Required,637
state,1,Available,704
state,20,Required,297
state,20,Available,331
state,29,Required,2359
state,29,Available,2136
state,32,Required,849
state,32,Available,1169
state,31,Required,4
state,31,Available,8
state,23,Required,1171
state,23,Available,954
state,27,Required,1814
state,27,Available,2929
state,14,Required,85
state,14,Available,194
state,17,Required,109
state,17,Available,112
state,15,Required,57
state,15,Available,56
state,13,Required,126
state,13,Available,122
state,7,Required,5
state,7,Available,21
state,21,Required,1280
state,21,Available,940
state,34,Required,40
state,34,Available,46
state,3,Required,432
state,3,Available,568
state,8,Required,2079
state,8,Available,2382
state,11,Required,24
state,11,Available,30
state,33,Required,1362
state,33,Available,2759
state,36,Required,689
state,36,Available,966
state,16,Required,93
state,16,Available,156
state,9,Required,3621
state,9,Available,2209
state,5,Required,257
state,5,Available,215
state,19,Required,914
state,19,Available,918
\.


--
-- TOC entry 2198 (class 2606 OID 21860)
-- Name: pk_allopathicdocphcs; Type: CONSTRAINT; Schema: public; Owner: wazimap
--

ALTER TABLE ONLY public.allopathicdocphcs
    ADD CONSTRAINT pk_allopathicdocphcs PRIMARY KEY (geo_level, geo_code, geo_version, allopathicdocphcs);


-- Completed on 2018-07-04 16:33:05 IST
