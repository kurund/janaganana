...
-- Started on 2018-07-04 15:50:50 IST
...
ALTER TABLE IF EXISTS ONLY public.villagescovered DROP CONSTRAINT IF EXISTS pk_villagescovered;
DROP TABLE IF EXISTS public.villagescovered;
SET default_tablespace = '';

SET default_with_oids = false;

--
-- TOC entry 242 (class 1259 OID 21843)
-- Name: villagescovered; Type: TABLE; Schema: public; Owner: wazimap
--
...
ALTER TABLE public.villagescovered OWNER TO wazimap;

--
-- TOC entry 2307 (class 0 OID 21843)
-- Dependencies: 242
-- Data for Name: villagescovered; Type: TABLE DATA; Schema: public; Owner: wazimap
--

COPY public.villagescovered (geo_level, geo_code, villagescovered, total) FROM stdin WITH DELIMITER ',';
country,IN,Sub Centre,165
country,IN,PHCS,888
country,IN,CHCS,3876
...
district,263,PHCS,0
district,263,CHCS,0
state,35,Sub Centre,5
state,35,PHCS,25
state,35,CHCS,139
state,28,Sub Centre,2
state,28,PHCS,15
state,28,CHCS,88
state,12,Sub Centre,18
state,12,PHCS,39
state,12,CHCS,89
state,18,Sub Centre,6
state,18,PHCS,26
state,18,CHCS,167
state,10,Sub Centre,5
state,10,PHCS,24
state,10,CHCS,299
state,4,Sub Centre,0
state,4,PHCS,2
state,4,CHCS,3
state,22,Sub Centre,4
state,22,PHCS,26
state,22,CHCS,119
state,26,Sub Centre,1
state,26,PHCS,7
state,26,CHCS,10
state,25,Sub Centre,1
state,25,PHCS,5
state,25,CHCS,10
state,30,Sub Centre,2
state,30,PHCS,14
state,30,CHCS,84
state,24,Sub Centre,2
state,24,PHCS,13
state,24,CHCS,50
state,6,Sub Centre,3
state,6,PHCS,19
state,6,CHCS,61
state,2,Sub Centre,10
state,2,PHCS,38
state,2,CHCS,232
state,1,Sub Centre,2
state,1,PHCS,10
state,1,CHCS,78
state,20,Sub Centre,8
state,20,PHCS,109
state,20,CHCS,172
state,29,Sub Centre,3
state,29,PHCS,12
state,29,CHCS,142
state,32,Sub Centre,0
state,32,PHCS,1
state,32,CHCS,4
state,31,Sub Centre,2
state,31,PHCS,5
state,31,CHCS,7
state,23,Sub Centre,6
state,23,PHCS,47
state,23,CHCS,178
state,27,Sub Centre,4
state,27,PHCS,24
state,27,CHCS,121
state,14,Sub Centre,6
state,14,PHCS,30
state,14,CHCS,152
state,17,Sub Centre,16
state,17,PHCS,63
state,17,CHCS,253
state,15,Sub Centre,2
state,15,PHCS,15
state,15,CHCS,92
state,13,Sub Centre,4
state,13,PHCS,11
state,13,CHCS,68
state,7,Sub Centre,11
state,7,PHCS,22
state,7,CHCS,7
state,21,Sub Centre,8
state,21,PHCS,40
state,21,CHCS,139
state,34,Sub Centre,1
state,34,PHCS,2
state,34,CHCS,23
state,3,Sub Centre,4
state,3,PHCS,29
state,3,CHCS,83
state,8,Sub Centre,3
state,8,PHCS,21
state,8,CHCS,77
state,11,Sub Centre,3
state,11,PHCS,19
state,11,CHCS,226
state,33,Sub Centre,2
state,33,PHCS,12
state,33,CHCS,42
state,36,Sub Centre,2
state,36,PHCS,16
state,36,CHCS,94
state,16,Sub Centre,1
state,16,PHCS,9
state,16,CHCS,42
state,9,Sub Centre,5
state,9,PHCS,29
state,9,CHCS,130
state,5,Sub Centre,9
state,5,PHCS,65
state,5,CHCS,280
state,19,Sub Centre,4
state,19,PHCS,44
state,19,CHCS,115
\.
...
--
-- TOC entry 2192 (class 2606 OID 21848)
-- Name: pk_villagescovered; Type: CONSTRAINT; Schema: public; Owner: wazimap
--

ALTER TABLE ONLY public.villagescovered
    ADD CONSTRAINT pk_villagescovered PRIMARY KEY (geo_level, geo_code, geo_version, villagescovered);


-- Completed on 2018-07-04 15:50:50 IST
